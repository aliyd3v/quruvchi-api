...
const { techsRouter } = require("./routes/techs.routes");
...
const Router = (app) => {
  app
    ...
    .use("/api/gallery", galleryRouter)
    .use("/api/ie", entryRouter)
    .use("/api/inbox", inboxRouter)
    ...
    .use("/api/partners", partnersRouter)
