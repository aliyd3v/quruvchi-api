  ...
  .object(
    {
      ...
      unit: z.enum([Unit.DAY, Unit.H, Unit.KG, Unit.L, Unit.M, Unit.M2, Unit.M3, Unit.PCS, Unit.TON], { message: "unit_in_day_h_kg_l_m_m2_m3_pcs_ton" }),
      unit_price: z
...
exports.workVolumeUpdateValidatorMiddleware = (req, _res, next) => {
