  ...
  .object(
    {
      ...
      prorab_id: z.number({ message: "prorab_id_must_be_number" }).refine((value) => !Number.isNaN(value) && value > 0, { message: "prorab_id_must_be_positive_integer" }),
...
exports.fundCreateValidatorMiddleware = (req, _res, next) => {
  const parsed = fundCreateDto.safeParse(req.body);
  if (parsed.error) {
