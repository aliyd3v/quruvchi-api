  ...
  .object(
    {
      ...
      recipientUserId: z.number({ message: "recipient_user_id_must_be_number" }).refine((value) => !Number.isNaN(value) && value > 0, { message: "recipient_user_id_must_be_positive_integer" }),
      amount: z
...
exports.createObjectToFundValidatorMiddleware = (req, _res, next) => {
