...
const dto = z
  .object(
    {
      toObjectId: z.number({ message: "to_object_id_must_be_number" }).refine((value) => !Number.isNaN(value) && value > 0, { message: "to_object_id_must_be_positive_integer" }),
      amount: z
...
exports.createFundToObjectValidatorMiddleware = (req, _res, next) => {
