...
exports.catalogDirectionCreateValidatorMiddleware = async (req, _res, next) => {
  if (!req.file) {
    return next(new AppError(400, "validation_error", formatZodError([{ path: ["file"], message: "file_cannot_be_empty" }])));
  }
